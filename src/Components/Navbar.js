  ...
  return (
    <div>
      <nav className="fixed w-full z-20 top-0 bg-orange-100 bg-opacity-80 ">
        <div className="max-width-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
          ...
          >
            <ul
              className={`flex flex-col p-4 md:p-0 mt-4 text-xl border cursor-pointer boredr-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 ${
